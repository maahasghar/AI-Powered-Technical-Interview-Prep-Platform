...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_problem_bank_difficulty'), 'problem_bank', ['difficulty'], unique=False)
    op.create_index(op.f('ix_problem_bank_title'), 'problem_bank', ['title'], unique=False)
    ...
    sa.ForeignKeyConstraint(['problem_id'], ['problem_bank.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
